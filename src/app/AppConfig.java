...
public class AppConfig {
	...
	public static int WEAK_BOUNDRY;

	public static int STRONG_BOUNDRY;
	...
	public static void readConfig(String configName){
		...
		WEAK_BOUNDRY = Integer.parseInt(properties.getProperty("weak_boundry"));
		STRONG_BOUNDRY = Integer.parseInt(properties.getProperty("strong_boundry"));
		...
		for (int i = 0; i < serventCount; i++) {
			...
			String serventWarehouse = properties.getProperty("servent"+i+".warehouse");
			
			ServentInfo newInfo = new ServentInfo("localhost", i, serventPort, neighborList, serventWarehouse);
